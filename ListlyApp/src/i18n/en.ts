export const en = {
  ...
  item_complete_all: 'Complete all',
  item_uncomplete_all: 'Uncomplete all',
  item_clear_completed: 'Clear completed',
  item_clear_completed_confirm: (count: number) => `Delete ${count} completed item${count === 1 ? '' : 's'}?`,
  item_clear_completed_message: 'Completed items will be permanently deleted.',
  item_sort: 'Sort items',
  item_sort_manual: 'Manual',
  item_sort_name: 'Name',
  item_sort_created: 'Created',
  item_sort_asc: 'Ascending',
  item_sort_desc: 'Descending',
